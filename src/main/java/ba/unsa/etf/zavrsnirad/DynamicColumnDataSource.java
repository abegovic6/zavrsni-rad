...
public class DynamicColumnDataSource extends JRAbstractBeanDataSource
{
    ...
    {
        // The name of the field in dynamic columns that were created by DynamicReportBuilder is also the index into the list of columns.
        ...
        if (fieldName.startsWith(DynamicReportBuilder.COL_EXPR_PREFIX)) {
            ...
            throw new IllegalArgumentException("The field name '" + fieldName + "' in the Jasper Report is not valid");
        }
    }
    @Override
